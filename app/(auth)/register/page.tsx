  ...
  if (success) {
    return (
      <div className="flex flex-col items-center justify-center text-center space-y-6 py-12 animate-in zoom-in-95 duration-500">
        ...
        <div>
          <h2 className="text-3xl font-serif font-bold text-obsidian-950 dark:text-white">Account Created</h2>
          <p className="mt-2 text-obsidian-500 dark:text-white/50">Redirecting you to sign in...</p>
        </div>
        <div className="w-full max-w-xs h-1.5 bg-obsidian-100 dark:bg-white/5 rounded-full overflow-hidden">
          <motion.div 
            initial={{ width: 0 }}
            animate={{ width: '100%' }}
    ...
    <div className="space-y-10 animate-in fade-in slide-in-from-bottom-5 duration-700">
      <div>
        <h1 className="text-4xl font-serif font-bold text-obsidian-950 dark:text-white leading-tight">
          Join the <span className="text-gold-500 italic">Elite</span>
        </h1>
        <p className="mt-4 text-obsidian-500 dark:text-white/50 font-outfit">
          Start your fractional real estate journey with PropChain today.
        </p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        <div className="space-y-2">
          <label className="text-sm font-semibold text-obsidian-700 dark:text-white/70 ml-1">Full Name</label>
          <div className="relative group">
            <User className="absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 text-obsidian-400 dark:text-white/20 group-focus-within:text-gold-500 transition-colors" />
            <input
              type="text"
              name="fullName"
              required
        ...
        <div className="space-y-2">
          <label className="text-sm font-semibold text-obsidian-700 dark:text-white/70 ml-1">Password</label>
          <div className="relative group">
          ...
          <p className="text-xs text-obsidian-400 dark:text-white/30 px-1 pt-1 italic">
      ...
      <div className="text-center">
        <p className="text-obsidian-500 dark:text-white/40 text-sm font-outfit">
          ...
          <Link href="/signin" className="text-gold-500 font-bold hover:underline">
            Sign In
          </Link>
        </p>
      </div>

      <div className="text-[10px] text-center text-obsidian-400 dark:text-white/20 px-8">
